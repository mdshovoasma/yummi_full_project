...
<div class="container-fluid ">
    <form action="../controller/EventAdd.php" method="Post" enctype="multipart/form-data">
    <div class="card">
        <div class="care-header">
           <h1>Add Events</h1>
           <div class="card-body">
            <input name="title" type="text" placeholder="Enter perties Name" class="mb-2"><br>
            <span class="text-danger"><?= isset($_SESSION['banner_erorr']['title_erorr'])?$_SESSION['banner_erorr']['title_erorr'] : ''  ?></span><br>


            <input name="taka" type="number" placeholder="price" class="mb-2"><br>

            <span class="text-danger"><?= isset($_SESSION['banner_erorr']['taka_erorr'])?$_SESSION['banner_erorr']['taka_erorr'] : ''  ?></span>
