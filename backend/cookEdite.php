...
$select = "SELECT * FROM cook_table WHERE id = '$id'";
...
<div class="container-fluid ">
    <form action="../controller/updatecook.php" method="Post" enctype="multipart/form-data">
    <div class="card">
        <div class="care-header">
           ...
           <div class="card-body">
            ...
            <div class="row mx-0">
                ...
                <label for="masterchif"> <img class="master rounded-circle" src="../uploads/cook_img/<?= isset($response['banner_img']) ?$response['banner_img'] : 'https://api.dicebear.com/7.x/avataaars/svg?seed=alex'?>" alt="" width="200" height="200"></label>
